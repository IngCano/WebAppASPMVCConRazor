...
namespace WebAppASPMVCConRazor.Models
{
    public class MovieDataSeeder{

        public static void Initialize(IServiceProvider serviceProvider)
        {
            using (var context = new WebAppASPMVCConRazorContext(
                serviceProvider.GetRequiredService<DbContextOptions<WebAppASPMVCConRazorContext>>()))
            {
